...
vector& vector::assign( const vector &right )
{
   ...
   {
       int right_s = right.myLast - right.myFirst;
       int right_c = right.myEnd - right.myFirst;
